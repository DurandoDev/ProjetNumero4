...
public class DBConstants {
    ...
    public static final String GET_NB_ENTRY = "select count(t.ID) from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? and t.OUT_TIME is not NULL";
